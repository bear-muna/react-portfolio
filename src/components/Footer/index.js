        ...
        <div className='container-fluid footer-container p-3'>
            <div className='row d-flex align-items-center justify-content-center'>
                <div className='col-1 text-center linked-in'>
                    <a href="https://www.linkedin.com/in/edward-john-muna-44b73423b" target='_blank' rel='noreferrer'>
                ...
                <div className='col-1 text-center github'>
                    <a href="https://github.com/bear-muna" target='_blank' rel='noreferrer'>
                        <svg width='25' height='25'>
                ...
                <div className='col-1 text-center twitter'>
                    <a href="https://twitter.com/ej_muna" target='_blank' rel='noreferrer'>
                        <svg width='25' height='25'>
