    ...
    return (
        <main className='portfolio-container container-fluid p-3'>
            ...
            <div className='row d-flex justify-content-around'>
                <div className='col-lg-3 col-md-5 col-12 proj p-3 m-3' id='proj-1'>
                ...
                <div className='col-lg-3 col-md-5 col-12 proj p-3 m-3' id='proj-2'>
                    <PortfolioCard name='Enter The Temple' stack='HTML/CSS/JS' link='https://github.com/bear-muna/enter-the-temple' />
                </div>
                <div className='col-lg-3 col-md-5 col-12 proj p-3 m-3' id='proj-3'>
